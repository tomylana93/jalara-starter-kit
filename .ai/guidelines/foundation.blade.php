...
- Run project tooling through scripts defined in `composer.json`; do not invoke tools from `vendor/bin` or scripts from `package.json` directly.
...
## Frontend Bundling
- If the user doesn't see a frontend change reflected in the UI, run `composer frontend:build` or ask them to run `composer dev`.
