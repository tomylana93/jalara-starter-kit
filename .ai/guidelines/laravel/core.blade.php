...
## Vite Error
- If you receive an "Illuminate\Foundation\ViteException: Unable to locate file in Vite manifest" error, run `composer frontend:build` or ask the user to run `composer dev`.
