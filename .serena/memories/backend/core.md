...
- Entry points: routes/web.php exposes the public Welcome page and verified dashboard; routes/settings.php owns authenticated profile/security/appearance routes.
